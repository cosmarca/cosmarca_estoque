defmodule CosmarcaEstoque.Stocks.Notazz.Producs_Registers do
    ...
    defp process_body(key, initial_date, final_date) do
        "fields=%7B%22API_KEY%22+%3A+%22#{key}%22%2C+%22METHOD%22%3A+%22consult_all_nfe_55%22%2C+%22FILTER%22%3A+%7B%22INITIAL_DATE%22%3A+%22#{initial_date}%22%2C+%22FINAL_DATE%22%3A+%22#{final_date}%22%7D%7D"
    end
